...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        SharedPreferences preferences = getSharedPreferences("options", 0);
        String restaurant = preferences.getString("place_selected", "");
        String[] restaurantInfo = restaurant.split("#");
        name = restaurantInfo[0];
        lat = Float.parseFloat(restaurantInfo[2]);
        lng = Float.parseFloat(restaurantInfo[3]);
    }
    ...
    public void changeMapStyle(View view)
    {
        if(mMap.getMapType() == GoogleMap.MAP_TYPE_NORMAL)
        {
            ...
            btnMapStyle.setText("Change to normal");
        }
        else
        {
            mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
            btnMapStyle.setText("Change to satellite");
        }
    }
